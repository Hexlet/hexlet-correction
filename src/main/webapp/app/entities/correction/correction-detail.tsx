...
export const CorrectionDetail = (props: ICorrectionDetailProps) => {
  useEffect(() => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate
            contentKey="hexletCorrectionApp.correction.detail.title">Correction</Translate> [<b>{correctionEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="textBeforeCorrection">
              <Translate
                contentKey="hexletCorrectionApp.correction.textBeforeCorrection">Text Before Correction</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="textAfterCorrection">
              <Translate
                contentKey="hexletCorrectionApp.correction.textAfterCorrection">Text After Correction</Translate>
            </span>
          </dt>
...
export default connect(mapStateToProps, mapDispatchToProps)(CorrectionDetail);

...
import io.hexlet.hexletcorrection.repository.AuthorityRepository;
...
import io.hexlet.hexletcorrection.service.dto.PasswordChangeDTO;
import io.hexlet.hexletcorrection.service.dto.UserDTO;
import io.hexlet.hexletcorrection.web.rest.vm.KeyAndPasswordVM;
...
import static io.hexlet.hexletcorrection.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
public class AccountResourceIT {
    ...
    public void testActivateAccount() throws Exception {
        ...
        final User activatedUser = userRepository.findOneByLogin(user.getLogin()).orElseThrow();

...
import io.hexlet.hexletcorrection.domain.PersistentAuditEvent;
...
import static io.hexlet.hexletcorrection.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
public class CustomAuditEventRepositoryIT {
    ...
    public void addAuditEventTruncateLargeData() {
        Map<String, Object> data = new HashMap<>();
        StringBuilder largeData = new StringBuilder("a".repeat(EVENT_DATA_COLUMN_MAX_LENGTH + 10));
